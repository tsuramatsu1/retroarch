...
mv $TEMPDIR/libretro-uae-$VER/puae2021_libretro.so "${ROOT_DIR}/.config/retroarch/cores/" || exit 1
wget $INFO -O "${ROOT_DIR}/.config/retroarch/cores/puae2021_libretro.info"
