...
mv $TEMPDIR/mame2003-plus-libretro-$VER/mame2003_plus_libretro.so "${SCRIPT_DIR}/.config/retroarch/cores/" || exit 1
wget $INFO -O "${SCRIPT_DIR}/.config/retroarch/cores/mame2003_plus_libretro.info"
